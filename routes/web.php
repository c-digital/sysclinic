...
Route::post('request_send', 'PlanRequestController@userRequest')->name('send.request')->middleware(['auth','XSS',]);
...
Route::resource('ecommerce', 'EcommerceController')->middleware(
    [
        'auth',
        'XSS',
        'revalidate',
