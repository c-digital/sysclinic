    ...
    <div class="row">
        <div class="col-lg-4 col-md-4 col-sm-6">
            <div class="form-group">
                <label for="photo">
                    <img id="user-photo" style="width: 100px; cursor: pointer" class="img-fluid" src="http://sysclinic.net/storage/uploads/avatar/User_font_awesome.svg_1667932474.png" alt="">
                </label>
        ...
        <div class="col-lg-4 col-md-4 col-sm-6">
            <div class="form-group">
                ...
                <div class="form-icon-user">
                    {{Form::text('age',null,array('id' => 'age', 'class'=>'form-control', 'readonly' => true))}}
                </div>
            </div>
        </div>
