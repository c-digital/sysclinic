                ...
                <div class="editor-content">
                    <div class="preview-main client-preview">
                        <div data-v-f2a183a6="" class="d" id="boxes" style="width:710px;margin-left: auto;margin-right: auto;">
                            <div data-v-f2a183a6="" class="d-header" style="background: {{$color}};color:{{$font_color}}">
                                <div data-v-f2a183a6="" class="d-header-inner">
                                    ...
                                    <div data-v-f2a183a6="" class="d-header-50 d-right">
                                        <div data-v-f2a183a6="" class="d-title">{{__('SESIONES')}}</div>
                            ...
                            <div data-v-f2a183a6="" style="marign-top: -1000px" class="d-body">
                                <div data-v-f2a183a6="" class="d-bill-to">
                                    <div class="row">
                                        <div class="bill_to">
                                            <strong data-v-f2a183a6="">{{__('Paciente')}}:</strong>
                                            <p>
                                                {{!empty($session->customer->name)?$session->customer->name:''}}<br>
                                                {{!empty($session->customer->email)?$session->customer->email:''}}<br>
                                                {{!empty($session->customer->contact)?$session->customer->contact:''}}<br>
                                                {{$session->customer->billing_address??$session->customer->shipping_address}}<br>
                                            </p>
                                        </div>
                                    </div>
                                                ...
                                                <tbody>
                                                    @foreach(json_decode($session->realized) as $realized)
                                                        <tr>
                                                            ...
                                                            <td style="text-align: center">{{ $realized->date }}</td>
                                                            <td style="text-align: center">{{ App\Models\User::find($realized->user)->name }}</td>
                                                        </tr>
                                                    @endforeach
                                                </tbody>
                                            </table>
