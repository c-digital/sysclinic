                            ...
                            <div data-v-f2a183a6="" class="d-header" style="background: {{$color}};color:{{$font_color}}">
                                <div data-v-f2a183a6="" class="d-header-inner">
                                    ...
                                    <div data-v-f2a183a6="" class="d-header-50 d-right">
                                        <div data-v-f2a183a6="" class="d-title">{{__('RECETA')}}</div>
                                ...
                                <div data-v-f2a183a6="" class="d-bill-to">
                                    <div class="row">
                                        <div class="bill_to">
                                            ...
                                            <p>
                                                {{!empty($recipe->customer->name)?$recipe->customer->name:''}}<br>
                                                {{!empty($recipe->customer->email)?$recipe->customer->email:''}}<br>
                                                {{!empty($recipe->customer->contact)?$recipe->customer->contact:''}}<br>
                                                {{$recipe->customer->billing_address??$recipe->customer->shipping_address}}<br>
                                            </p>
                                        </div>
                                        ...
                                        <div class="ship_to">
                                            ...
                                            <p>
                                                {{!empty($recipe->user->name)?$recipe->user->name:''}}<br>
                                                {{!empty($recipe->user->email)?$recipe->user->email:''}}<br>
                                                {{!empty($recipe->user->contact)?$recipe->user->contact:''}}<br>
                                                {{$recipe->user->billing_address??$recipe->user->shipping_address}}<br>
                                            </p>
                                        </div>
                                    </div>
