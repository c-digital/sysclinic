        ...
        <div class="navbar-content">
            <?php if(\Auth::user()->type != 'client'): ?>
                ...
                <?php endif; ?>
                    ...
                    <li class="dash-item dash-hasmenu <?php echo e((Request::segment(1) == 'ecommerce')?'active':''); ?>">
                        <a href="<?php echo e(route('ecommerce.index')); ?>" class="dash-link">
                            <span class="dash-micon"><i class="fa fa-shopping-cart"></i></span><span class="dash-mtext"><?php echo e(__('E-Commerce')); ?></span>
                        </a>
                    </li>
