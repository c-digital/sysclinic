        ...
        <div class="row align-items-center justify-content-between">
            <div class="col-sm-5">
                ...
                <h2
                    ...
                    data-wow-delay="0.4s"
                >
                    <?php echo e(__('Todo lo que necesita para administrar tu empresa.(Finanzas, Cuentas, ERP, Proyectos, Recursos Humanos, CRM)')); ?>
    ...
    <div class="container">
        <div class="row align-items-center justify-content-end mb-5">
            <div class="col-sm-4">
                ...
                <h2 class="mb-sm-4 wow animate__fadeInLeft" data-wow-delay="0.4s">
                    <?php echo e(__('Cards para avisos claro de estados y de tomas')); ?>
        ...
        <div class="row align-items-center justify-content-start">
            ...
            <div class="col-sm-4">
                ...
                <h2 class="mb-sm-4 wow animate__fadeInRight" data-wow-delay="0.4s">
                    <?php echo e(__('Integración con el más famoso app de trabjo en equipe')); ?>
