...
<?php $__env->startSection('content'); ?>
    <div class="row">
        <?php $__currentLoopData = $plans; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $plan): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                ...
                                <?php if(\Auth::user()->type != 'super admin'): ?>
                                    ...
                                    <?php if($plan->id != 1 && $plan->id != \Auth::user()->plan): ?>
                                        <?php if(\Auth::user()->requested_plan != $plan->id): ?>
                                            <a data-bs-toggle="modal" data-bs-target="#exampleModal_<?php echo e($plan->id); ?>" href="#" class="btn btn-primary btn-icon m-1" data-title="<?php echo e(__('Send Request')); ?>" data-bs-toggle="tooltip" title="<?php echo e(__('Send Request')); ?>">
                                                Pago en Bolivia
                                            </a>
                                        <?php else: ?>
                                            <?php if(\Auth::user()->type != 'super admin'): ?>
            ...
            <!-- Modal -->
            <div class="modal fade" id="exampleModal_<?php echo e($plan->id); ?>" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
              <div class="modal-dialog">
                <div class="modal-content">
                    <form enctype="multipart/form-data" method="POST" action="<?php echo e(route('send.request')); ?>">
                      ...
                      <div class="modal-body">
                        ...
                        <img class="img-fluid" src="/storage/receipts/ganadero.jpeg" alt="">
